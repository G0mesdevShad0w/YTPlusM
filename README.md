...
## Soon download table will be deleted and also releases' files due to legal reason; I will do a better guide to build yourself the IPA with Actions and where find the decrypted IPA. I'm sorry for this, but it's necessary if you want to see survive this repository :( 
